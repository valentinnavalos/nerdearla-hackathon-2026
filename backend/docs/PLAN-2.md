...
> Documento de trabajo del equipo. Consolida la arquitectura, el roadmap y los riesgos.
> Reemplaza las decisiones de `referencia-proyecto.md` donde haya conflicto (ver sección 0).
...
└─────────────────────┘                  │  ├─ Glosario (post-proceso o custom_vocab)   │
...
```json
{"session":"sala-1","lang":"es","seg":42,"final":true,"text":"...","t0":812.4,"t1":815.9,"lat_ms":1340}
```
