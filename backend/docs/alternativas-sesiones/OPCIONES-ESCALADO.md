...
- Google APIs Terms of Service (sección *API Limitations*): https://developers.google.com/terms
- Gemini API Additional Terms of Service: https://ai.google.dev/gemini-api/terms
- Gemini API — Rate limits (por proyecto): https://ai.google.dev/gemini-api/docs/rate-limits
